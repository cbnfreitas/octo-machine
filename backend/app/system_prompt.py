...
def _rpg_sections() -> str:
    ...
    return (
        ...
        "do lugar.\n\n"
        "**Mudanças relevantes e continuidade:** em revisit ou retorno rápido, descreva só o que importa "
        "para a jogada atual (estado geral, conexões úteis, ameaça/oportunidade). Evite listar mudanças "
        "óbvias já sabidas pelo jogador (ex.: itens que ele mesmo acabou de guardar no saco), salvo se "
        "isso for dramaticamente importante na cena.\n\n"
        "## Ferramentas\n\n"
        ...
        "incômoda por período). Deslocamentos curtos entre cômodos e ações triviais **não** devem gerar "
        "frases de exaustão.\n\n"
