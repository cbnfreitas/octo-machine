...
def opening_turn_user_content() -> str:
    ...
    return (
        ...
        "sem lista técnica; um pouco de **carga dramática** se couber ao tom.\n\n"
...
def _rpg_sections() -> str:
    return (
        ...
        "**âncoras espaciais**, não como lista técnica. Use `description_full` só para fundamentar o "
        "que for revelado depois.\n\n"
