...
def _rpg_sections() -> str:
    ...
    return (
        ...
        "O **ENGINE_CONTEXT** pode repetir, para o lugar atual, a **camada extra perceptível** (sem "
        "marcadores de segredo) e a **referência de autoria** (texto completo com segredos: **só** para "
